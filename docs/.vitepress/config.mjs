...
export default defineConfig({
  title: 'Lando Elasticsearch Plugin',
  description: 'The offical Lando plugin for Elasticsearch.',
  landoDocs: 3,
  landoPlugin,
  version,
  head: [
...
function sidebar() {
  return [
    ...
    },
    {
      ...
      collapsed: false,
      items: [
        {text: 'GitHub', link: 'https://github.com/lando/elasticsearch/issues/new/choose'},
